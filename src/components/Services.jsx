              ...
              <div className='relative z-1 max-w-[17rem] ml-auto'>
                ...
                <ul className='body-2'>
                {
                  brainwaveServices.map((item, idx)=> (
                    <li key={idx} className='flex items-start py-4 border-t border-n-6'>
                    ...
                    <ul className='flex items-center justify-between'>
                      {
                        brainwaveServicesIcons.map((item, idx) => (
                          ...
                          className={`rounded-2xl flex items-center justify-center 
                            ${idx === 2 ? "w-[3rem] h-[3rem] p-0.25 bg-conic-gradient md:w-[4.5rem]" :
                               "flex w-10 h-10 bg-n-6 md:w-15 md:h-15"}`}
                          >
                            <div className={idx === 2 ? "flex items-center justify-center w-full h-full bg-n-7 rounded-[1rem]" : ""}>
